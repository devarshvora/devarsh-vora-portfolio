...
const FeatureCard = ({
  ...
  >
    ...
    <div className="flex-1 flex flex-col ml-4">
      ...
      <p className="font-poppins font-medium text-white text-[18px] leading-[30px] mb-1">
        {degree}
      </p>
      <p className="font-poppins font-medium text-white text-[18px] leading-[30px] mb-1">
        {duration}
      ...
      {content2 && (
        <p className="font-poppins font-normal text-white text-[18px] leading-[28px] mb-1">
          ● {content2}
        </p>
      )}
      ...
      {transcript && (
        <a
          ...
          className="text-[16px] font-poppins mt-2 text-teal-400 hover:underline"
        >
          View transcript →
        </a>
      )}
